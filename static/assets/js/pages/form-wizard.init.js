document.querySelector("#profile-img-file-input") && document.querySelector("#profile-img-file-input").addEventListener("change", function() {
        var e = document.querySelector(".user-profile-image"),
            ...
            r = new FileReader;
        r.addEventListener("load", function() { e.src = r.result }, !1), t && r.readAsDataURL(t)
    }),
    document.querySelectorAll(".form-steps") && Array.from(document.querySelectorAll(".form-steps")).forEach(function(l) {
        l.querySelectorAll(".nexttab") && Array.from(l.querySelectorAll(".nexttab")).forEach(function(t) {
            ...
            Array.from(e).forEach(function(e) { e.addEventListener("show.bs.tab", function(e) { e.target.classList.add("done") }) }), t.addEventListener("click", function() { l.classList.add("was-validated"), l.querySelectorAll(".tab-pane.show .form-control").forEach(function(e) { 0 < e.value.length && e.value.match(/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/) && (e = t.getAttribute("data-nextt ab"), document.getElementById(e).click(), l.classList.remove("was-validated")) }) })
